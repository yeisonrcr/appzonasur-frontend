...
function Button({ 
  ...
  const variants = {
    ...
    secondary: 'bg-neutral-600 text-white hover:bg-neutral-700 focus:ring-neutral-500 disabled:bg-neutral-300 disabled:cursor-not-allowed shadow-sm hover:shadow-md',
